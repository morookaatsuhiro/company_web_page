...
def admin_save(
    ...
    try:
        ...
        update_data = HomeUpdate(
            ...
            hero_stats=hero_stats_list if hero_stats_list else None,
            concept_title=_clean(concept_title),
            concept_subtitle=_clean(concept_subtitle),
            concept_points=concept_points_list if concept_points_list else None,
            ...
            contact_examples=contact_examples_list if contact_examples_list else None,
            ...
            strengths=strengths_list if strengths_list else None,
        )
